  ...
  <form action="{{$action}}" method="post" enctype="multipart/form-data">
    ...
    <div>
      @if (!$new && !empty($question->image))
        <img src="{{$question->image}}" width="250" style="margin-right: 20px; margin-bottom: 10px;">
    ...
    <button type="submit" style="margin-bottom: 40px;" class="btn btn-primary btn-sm float-right">@if($new) Add @else Save @endif Question</button>
  </form>
</div>
